        ...
        <div>
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID,User_id" DataSourceID="UserPassword" OnPageIndexChanging="FormView1_PageIndexChanging" DefaultMode="Edit">
                <EditItemTemplate>
                    ...
                    <br />
                    PlainTextPassword:
                    <asp:TextBox ID="PlainTextPassword" runat="server" Text='<%# Bind("PlainTextPassword") %>' />
                    &nbsp;<asp:Button ID="Hash" runat="server" OnClick="Hash_OnClick" Text="Hash Password" />
                    <br />
                    <br />
                    HashedPassword:
                    <asp:TextBox ID="HashedPassword" runat="server" Text='<%# Bind("HashedPassword") %>' Width="851px" />
                    <br />
...
&nbsp;<asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
        ...
        <p>
            &nbsp;</p>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,User_id" DataSourceID="SqlDataSource1" Width="705px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString4 %>" ProviderName="<%$ ConnectionStrings:ConnectionString4.ProviderName %>" SelectCommand="SELECT * FROM [user_access] WHERE ([User_id] = ?)">
            <SelectParameters>
